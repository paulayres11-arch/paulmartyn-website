...
export const WHY_US = {
  ...
  items: [
    ...
    },
    {
      ...
      body: "Paul leads every project personally. You'll always know who to call and what's happening on site.",
      icon: "user",
    },
  ] satisfies BoxLink[],
};
