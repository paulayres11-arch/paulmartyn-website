  ...
  return (
    <PageShell title={PRICING.title}>
      ...
      <section className="bg-pm-cream py-[10vh]">
        <div className="mx-auto flex max-w-[2000px] flex-col gap-14 px-[3%] lg:flex-row lg:gap-20">
          {/* Cost examples keeps the left third; the estimator takes the
              remaining two, which is what lets its questions sit in the middle
              of the page with the running total beside them. */}
          ...
          {/* The estimator uses container queries, so it lays itself out from
              the width of this column rather than the viewport. */}
